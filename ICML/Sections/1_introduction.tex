...
On repository-level coding tasks such as those in the popular SWE-Bench benchmark \citep{jimenez2024swebenchlanguagemodelsresolve}, a critical first step is \textbf{code localization}: given an issue description and a repository, the system must identify the relevant files and finer-grained code entities (e.g., classes and functions) to modify~(\S\ref{sec:background}; \citet{husain2019codesearchnet,xia2024agentless}).
