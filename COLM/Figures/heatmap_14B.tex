\begin{figure*}[!h]
    ...
    \caption{Distribution of the top-8 most frequent commands used by \methodname during RL. While both LLMs initially use various utilities, they use a very small set of commands as training proceeds. \methodname-14B \emph{only} uses ripgrep (rg) and sed, while \methodname-4B mainly uses rg, cat, sed, and xargs.}
